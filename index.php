...
<head>
  <meta charset="UTF-8">
  <meta http-equiv="X-UA-Comjpatible" content="IE=edge">
  ...
  <div class="box">
    ...
    <div class="navigation">
      <div class="nav-titleBox co zz">
        ...
        <!-- 标题 -->
        <div class="co-right ">
          <span class="titleBox-tag">Welcome to this site！</span>
          <h1>
            欢迎访问一小若水の小窝
          </h1>
      ...
      <div class="co-left">
        ...
        <div class="me-card carbox borderbefore" id="mycard">
          <div class="mecar-title">
            ...
            <h3>一小若水</h3>
            <p class="me-hover">平凡的一生写一个有趣的故事</p>
          </div>
          <div class="borderbotm"></div>
          <div class="lianxi-list">
            <a title="wx:w15165841829">
            ...
            <a title="哔哩哔哩:一小若水" href="https://space.bilibili.com/325681136?spm_id_from=333.1007.0.0">
              <svg t="1649145950732" class="icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path d="M512 118.4c-217.6 0-396.8 179.2-396.8 396.8s179.2 396.8 396.8 396.8 396.8-179.2 396.8-396.8S729.6 118.4 512 118.4z m183.466667 268.8l-85.333334 117.333333 85.333334 117.333334-143.36 83.2-85.333333-117.333334-85.333334 117.333334-143.36-83.2 85.333334-117.333334-85.333334-117.333333 143.36-83.2 85.333334 117.333333 85.333333-117.333333 143.36 83.2z"
                      fill="#FF69B4" p-id="16368"></path>
                <path d="M512 236.8c24.533333 0 46.933333 4.266667 68.266667 10.666667l-29.866667 40.533333c-14.933333-4.266667-29.866667-6.4-46.933333-6.4-17.066667 0-32 2.133333-46.933334 6.4l-29.866666-40.533333c21.333333-6.4 43.733333-10.666667 68.266667-10.666667z"
                      fill="#FFFFFF" p-id="16369"></path>
              </svg>
            </a>
            <a title="email:3230723103@qq.com" href="Mailto:3230723103@qq.com?Subject=邮箱标题&amp;Body=邮箱内容！">
          ...
          <div class="mecar-bottm">
            <div>
              ...
              <span class="mecarbottm-value">山东工程职业技术大学</span>
            </div>
            <div>
              <span class="mecarbottm-key">所在城市</span>
              <span class="mecarbottm-value">山东 济南</span>
            </div>
            <div>
              <span class="mecarbottm-key">年级</span>
              <span class="mecarbottm-value">23届</span>
            </div>

          </div>
          <div class="borderbotm"></div>
          <div class="buttom-box ">
            <a class="button" href="Mailto:3230723103@qq.com?Subject=邮箱标题&amp;Body=邮箱内容！">联系我</a>
          </div>
        </div>
      </div>
      <!-- 右边 -->
      <div class="co-right" id="next-one">
        ...
        <div class="content-li li2">
          ...
          <div class="carbox li2-box">
            <blockquote>
              这里是一小若水的个人网站哦，会发一些手机或是电脑上实用的东西，分享一些<s>奇怪的知识（doge）</s><br>
              <b>网站只做交流学习用，禁止商用</b><br>
			</blockquote>
			  <div class="borderbotm"></div>
			  <ul>
				  <li>2025.3.17更新：更新软件分享页面。</li>
			  </ul>
          </div>
        </div>
        <!-- 软件分享 -->
        <div class="content-li li2">
          ...
          <div class="carbox li2-box">
            <blockquote>
              这里是分享软件的地方哦，可以点击访问分享软件的详细页。φ(゜▽゜*)♪<br>
				<p></p>
				<a href="appshare.html">
				<button class="ruanjianfenxiang" >软件分享详细页</button>
				</a>
            </blockquote>
          </div>
        </div>
        ...
        <div class="content-li li1">
          <div class="li1-box borderbefore">
            <span>音乐</span><span class="tag">o(^▽^)o</span>
            <div class="borderbotm"></div>
            <div class="player">
            <div>
              <audio src="img/Forest Mixtape - 秋野桜.mp3" controls></audio>
            </div>
              </div>
          </div>
          <div class="li1-box borderbefore">
            <span>游戏</span><span class="tag">|ω・）&nbsp;</span>
            <div class="borderbotm"></div>
            <a href="game.html">
              <button class="button-game">开始游戏</button>
            </a>
          </div>
          <div class="li1-box borderbefore">
            <span>小说</span><span class="tag">(′▽`〃)</span>
            <div class="borderbotm"></div>
            <a href="https://www.wenku8.net/book/2654.htm">
              <button class="button-read">阅读</button>
            </a>
          </div>
        </div>
        ...
        <div class="content-li li7">
          ...
          <div class="li7-box">
            <div class="carbox li7boxitem ">
              ...
              <button class="buttonsty">详细</button>
            </div>
        ...
        <div class="content-li li6">
          ...
          <div class="li6-box">
            ...
            <div class=" carbox">
              ...
              <div class="li6car-title">deepseek本地部署
